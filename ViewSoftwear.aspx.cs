...
public partial class ViewSoftwear : System.Web.UI.Page
{
...
try
 ...
 ViewSoftwear.code_post= Page.Request.QueryString["page"].ToString();
 key_url = Page.Request.Url.ToString();
   

if(ViewSoftwear.code_post == Page.Request.QueryString["page"].ToString())
{
Class1.status_createTagLinkPost =false;
Class1.url_Address = key_url;
}

else if(ViewSoftwear.code_post != Page.Request.QueryString["page"].ToString())
{
...
Class1.url_Address = Page.Request.Url.ToString();
 ...
 string str3 = "";
        ...
        SqlParameter param;
         ...
         param.Value = ViewSoftwear.code_post;
...
Class1.url_Address = Class1.url_Address.Split('&')[0];//جلوگیری از تکرار چاپ کلمات کلیدی
 ...
 string s9= Page.Request.Url.ToString();
    ...
    public void View_comment_Enable()
    {
        ...
        string query = "SELECT * FROM comments WHERE  code_post = @code_post and status=@status";
