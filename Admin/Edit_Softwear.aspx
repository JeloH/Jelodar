...
<asp:Parameter Name="seo" Type="String" />
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="code_post" 
                ...
                <AlternatingItemTemplate>
                    ...
                    <br />
                    <asp:Button ID="EditButton" runat="server" CommandName="Edit" Text="یرایش" />
                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="حذف" />
                    </span>
                </AlternatingItemTemplate>
                <EditItemTemplate>
                    کد پست<span style="background-color: #DFC24F; color: #0000FF;">:
...
<br />
                    ...
                    <asp:Button ID="UpdateButton" runat="server" CommandName="Update" 
                        Text="به روز رسانی" />
                    <asp:Button ID="CancelButton" runat="server" CommandName="بستن" Text="بستن" />
                    </span>
                </EditItemTemplate>
                <EmptyDataTemplate>
