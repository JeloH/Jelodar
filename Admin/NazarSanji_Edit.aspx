                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                ...
                                <Columns>
                                    <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" 
                                        CancelText="بستن" DeleteText="حذف" EditText="ویرایش" 
                                        UpdateText="به روز رسانی" />
                                    <asp:BoundField DataField="code" HeaderText="کد" InsertVisible="False" 
                                        ReadOnly="True" SortExpression="code" />
                                    <asp:BoundField DataField="question" HeaderText="سوال" 
                                        SortExpression="question" />
                                    <asp:BoundField DataField="a" HeaderText="گزینه a" SortExpression="a" />
                                    <asp:BoundField DataField="b" HeaderText="گزینه b" SortExpression="b" />
                                    <asp:BoundField DataField="c" HeaderText="گزینه c" SortExpression="c" />
                                    <asp:BoundField DataField="d" HeaderText="گزینه d" SortExpression="d" />
                                    <asp:BoundField DataField="a_text" HeaderText="گزینه a_متن" 
                                        SortExpression="a_text" />
                                    <asp:BoundField DataField="b_text" HeaderText="گزینه b_متن" 
                                        SortExpression="b_text" />
                                    <asp:BoundField DataField="c_text" HeaderText="گزینه c_متن" 
                                        SortExpression="c_text" />
                                    <asp:BoundField DataField="d_text" HeaderText="گزینه d_متن" 
                                        SortExpression="d_text" />
                                    <asp:BoundField DataField="date_create" HeaderText="تاریخ ایجاد" 
                                        SortExpression="date_create" />
                                    <asp:CheckBoxField DataField="Enable" HeaderText="وضعیت فعال سازی نمایش" 
