            ...
            <td align="center">
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" PageSize="50"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="rpt" HeaderText="ردیف" InsertVisible="False" 
                            ReadOnly="True" SortExpression="rpt" />
                        <asp:BoundField DataField="us" HeaderText="نوع کاربر" SortExpression="us" />
                        <asp:BoundField DataField="date_login" HeaderText="تاریخ ورود" 
                            SortExpression="date_login" />
                        <asp:BoundField DataField="date_logout" HeaderText="تاریخ خروج" 
                            SortExpression="date_logout" />
                        <asp:BoundField DataField="ip_login" HeaderText="آی_پی وارد شونده" 
                            SortExpression="ip_login" />
                        <asp:BoundField DataField="contry" HeaderText="کشور" 
